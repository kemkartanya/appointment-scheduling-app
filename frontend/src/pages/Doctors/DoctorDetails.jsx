          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <h3 className='text-headingColor text-[22px] leading-9 mt-3 font-bold'>Muhiman Rubinar</h3>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Hic eum adipisci fuga maxime! 
                  Reprehenderit qui unde repellendus pariatur esse blanditiis tempore.
                </p>
              </div>
            </div>
